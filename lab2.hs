...
--toDigits n = [fromIntegral (ord c - ord '0') | c <- show n]
...
doubleSecond ns = [if even i then n else 2*n | (n, i) <- zip ns [0 ..]]
--doubleSecond [] = []
--doubleSecond [n] = [n]
--doubleSecond (n : ns) = n : 2*head ns : doubleSecond (tail ns)


sumDigits :: [Integer] -> Integer
sumDigits ns = sum [sum (toDigits n) | n <- ns]
--sumDigits ns = sum (concat [toDigits n | n <- ns])
